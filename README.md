...
> [!TIP]
> **Новое в 0.16.0:** вкладка «Финплан». В ней весь финансовый план в восьми шагах, калькуляторы образования детей и пенсии, распределение накоплений по классам активов и план в PDF, который можно распечатать.
...
> [!NOTE]
> Перед первым запуском e2e: `npx playwright install chromium`. Сценарии идут в двух ширинах экрана (1280 и 375 px). Отдельно проверяются скорость на 10 000 операций и доступность: контраст, клавиатура и подписи на всех экранах в обеих темах.
