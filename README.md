...
<a href="https://github.com/VPnus/konvert-me/releases"><img src="https://img.shields.io/badge/%D0%92%D0%B5%D1%80%D1%81%D0%B8%D1%8F-0.17.0-000000?style=for-the-badge" alt="Версия 0.17.0"></a>
...
> [!TIP]
> **Новое в 0.17.0:** у Конверкота есть сайт для пилота. Новый человек попадает на лендинг, читает, что считает приложение и где хранятся данные, и сразу начинает знакомство. Есть политика конфиденциальности, а в настройках статистика пилота без сумм и имён, которую человек копирует сам. Сайт публикуется одной командой на GitVerse Pages.
...
| MVP  | Публикация и пилот на 10–20 людях          | дальше |
