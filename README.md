...
<a href="https://github.com/VPnus/konvert-me/releases"><img src="https://img.shields.io/badge/%D0%92%D0%B5%D1%80%D1%81%D0%B8%D1%8F-0.18.1-000000?style=for-the-badge" alt="Версия 0.18.1"></a>
...
<img src="https://img.shields.io/badge/%D0%9C%D0%BE%D0%B4%D1%83%D0%BB%D1%8C%D0%BD%D1%8B%D1%85_%D1%82%D0%B5%D1%81%D1%82%D0%BE%D0%B2-652-2b9246?style=flat-square&logo=vitest&logoColor=white" alt="652 модульных теста">
<img src="https://img.shields.io/badge/E2E-183_%D0%BF%D1%80%D0%BE%D0%B3%D0%BE%D0%BD%D0%B0-2b9246?style=flat-square&logo=playwright&logoColor=white" alt="183 e2e-прогона">
...
> [!TIP]
> **Новое в 0.18.1:** на телефоне виджеты «Обзора» перетаскиваются пальцем и меняют высоту за уголок, а значок во вкладке браузера стал крупнее. **В 0.18.0:** кредитка с льготным периодом. Условия карты вписываются из договора, и приложение называет сумму, которая сохраняет льготный период, напоминает о сроке за неделю и за день, а после срока предупреждает о процентах. Перевод с кредитки заранее говорит, когда вернуть деньги, финплан гасит долги одной очередью, проценты накопительных счетов записываются в одно касание. На телефоне вкладки стоят столбиком справа или слева, рядом с темой есть значок для письма о проблеме, а о новой версии приложение сообщает само.
...
| 9.2  | Английский перевод                         | дальше |
| 9.3  | Страна в данных и нормативах               | дальше |
| 9.4  | Экономика США                              | дальше |
| 9.5  | Проверка и выпуск 0.19.0                   | дальше |
