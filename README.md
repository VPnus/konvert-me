...
| 10   | Криптовалюта: монеты, сделки, доля риска   | дальше |
| 11   | Десктоп на Tauri (Windows, Linux)          | дальше |
| 12   | Мобильная версия на Capacitor (Android)    | дальше |
| 13   | Синхронизация между устройствами           | дальше |
| 14   | Версия для компаний 2–500 человек          | дальше |
