...
export const RULES_2026: YearRules = {
  ...
  lifeInsuranceInLongTermSavings: {
    ...
    checkedAt: CHECKED,
    note:
      'Федеральный закон от 17.11.2025 № 418-ФЗ: с 1 сентября 2026 года взносы по договорам ' +
      'добровольного страхования жизни, заключённым с 1 января 2025 года, входят в вычет на ' +
      'долгосрочные сбережения (ст. 219.2) с общим лимитом. Минимальный срок договора источники ' +
      'называют по-разному (10 лет или 5 лет с ростом до 10), а о взносах 2026 года до 1 сентября закон ' +
      'прямо не говорит. Поэтому приложение по этой норме ничего не считает, а только показывает ' +
      'подсказку у страхования жизни; по договорам до 2025 года остаётся социальный вычет.',
  },
