import type { MonthDay, Norm, YearRules } from '../types';
...
/** The norms of a year in Russia: the tax, its deductions and the dates of a return. */
export interface RuYearRules extends YearRules {
